...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<head>
			...
			<table>
				<tbody>
					<tr>
						...
						<security:authentication var="uN" property="principal.username" />
						<td><form:input value="${uN}" path="firstName" /></td>
					...
					<tr>
						<td><label>Your Comment about Me & My Work (thanks <3):</label></td>
		...
		<p>
			<a href="${pageContext.request.contextPath}/customer/secondpage">Go Back</a>
		</p>
